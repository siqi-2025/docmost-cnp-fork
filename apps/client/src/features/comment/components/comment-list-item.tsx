...
import CommentAiBadge from "@/features/comment/components/comment-ai-badge";
import CommentAiSuggestionModal from "@/features/comment/components/comment-ai-suggestion-modal";
...
function CommentListItem({
  ...
  const [aiSuggestion, setAiSuggestion] = useState<AiReviewSuggestion | null>(
    null,
  );
    ...
    <Box ref={ref} pb="xs">
      <Group>
        ...
        <div style={{ flex: 1 }}>
          ...
          <CommentAiBadge
            comment={comment}
            onOpenSuggestion={(s) => setAiSuggestion(s)}
          />
        </div>
      </Group>
      ...
      <CommentAiSuggestionModal
        opened={aiSuggestion != null}
        onClose={() => setAiSuggestion(null)}
        suggestion={aiSuggestion}
        account={comment.aiReviewAccount}
        reviewedAt={comment.aiReviewedAt}
        commentId={comment.id}
      />
    </Box>
  );
